# TaskForge — Style Guide

This document is the single source of truth for all visual design, component standards, iconography, and branding decisions. All frontend implementation must adhere to these specifications.
